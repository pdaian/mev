...
def parse_uniswap_tokenpurchase(topics, data, address):
    ...
    assert(len(topics) == 4)
    return (tokenget_addr, tokenget_label, tokenget, amountget, tokengive_addr, tokengive_label, tokengive, amountgive, abi_data[-1], abi_data[-2])
...
def get_trade_data_from_log_item(topics, data, address):
    exchange = None
    parser = None
    if address == '0x12459c951127e0c374ff9105dda097662a027093': # 0x v1
        ...
        if topics[0] == '0x0bcc4c97732e47d9946f229edb95f5b6323f601300e4690de719993f3c371129':
            exchange = "0x v2"
            parser = parse_0x_v2
    elif address == '0x8d12a197cb00d4747a1fe03395095ce2a5cc6819': # etherdelta
        # TODO handle clones
    ...
    (tokenget_addr, tokenget_label, tokenget, amountget, tokengive_addr, tokengive_label, tokengive, amountgive, rawget, rawgive) = parser(topics, data, address)
    return [(tokenget_addr, tokenget_label, tokenget, amountget, tokengive_addr, tokengive_label, tokengive, amountgive, exchange, rawget, rawgive)]
