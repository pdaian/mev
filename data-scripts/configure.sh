...
python3 uniswapv2_trades.py &> uniswapv2_trades.nohup #run for both unsiwapv2 and sushiswap
python3 uniswapv2_reserves.py -e sushiswap &> uniswapv2_reserves.nohup
